      ...
      <div className="flex shrink-0 items-center gap-1 sm:gap-3">
        <div className="hidden md:flex items-center gap-2 border-r border-border pr-3 text-sm text-muted-foreground">
          ...
          <div>
            ...
            <time
              ...
              aria-label={`Current device time: ${liveTime}`}
            >
              {liveTime}
            </time>
          </div>
        ...
        <div className="relative">
          <button
            ...
            className="flex items-center gap-3 rounded-xl p-1.5 hover:bg-surface-secondary"
            onClick={() => setAccountOpen(!accountOpen)}
            aria-expanded={accountOpen}
          >
            <div className="grid h-10 w-10 place-items-center rounded-full bg-primary-soft text-sm font-bold text-primary-text">
              {initials(user.name)}
            </div>
          ...
          {accountOpen && (
            <div className="absolute right-0 mt-2 w-72 max-w-[calc(100vw-1rem)] rounded-xl border border-border bg-surface p-2 text-sm shadow-xl">
              ...
              <button
                ...
                className="flex w-full items-center gap-2 rounded-lg px-3 py-2 hover:bg-surface-secondary sm:hidden"
              >
              ...
              <Link
                ...
                className="flex items-center gap-2 rounded-lg px-3 py-2 hover:bg-surface-secondary"
              >
              ...
              <button
                onClick={logout}
                className="mt-1 flex w-full items-center gap-2 border-t border-border px-3 py-2 pt-3 text-danger hover:bg-danger-soft"
              >
