            ...
            <tr className="border-b last:border-0 hover:bg-slate-50" key={e.id}>
              ...
              <td className="px-5">
                <div className="flex gap-1">
                  ...
                  {canResetPassword && <button title="Reset Password" className="rounded-lg p-2 hover:bg-indigo-50 hover:text-indigo-600" onClick={() => onResetPassword(e)}><KeyRound size={17}/></button>}
                  {canDeactivate && (
                    <button
                  ...
                  {canDelete && <button title="Delete Employee" className="ml-1 rounded-lg border-l border-slate-200 p-2 text-red-600 hover:bg-red-50" onClick={() => onDelete(e)}><Trash2 size={17}/></button>}
                </div>
              </td>
            </tr>
          ))}
