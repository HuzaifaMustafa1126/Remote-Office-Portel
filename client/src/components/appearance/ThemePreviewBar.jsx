...
export default function ThemePreviewBar() {
  ...
  return (
    <div
      ...
      className="fixed inset-x-3 bottom-4 z-[70] mx-auto flex max-w-xl flex-wrap items-center justify-between gap-3 rounded-2xl border border-primary-border bg-surface p-4 text-foreground shadow-2xl"
    >
      <p
        role="status"
      ...
      >
        <Eye size={18} />
        Previewing {paletteFor(preview).name}
      </p>
