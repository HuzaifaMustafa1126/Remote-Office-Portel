...
export default function useAttendance(){
  ...
  const refresh=useCallback(async()=>{try{const latest=await attendance.getToday();setData(latest);setError('');return latest}catch(e){setError(errorMessage(e));throw e}},[]);
