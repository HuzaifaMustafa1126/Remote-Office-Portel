...
const r = Router();
r.get("/", p("roles.view"), asyncHandler(c.list));
r.post("/", p("roles.manage"), validate(roleSchema), asyncHandler(c.create));
r.put("/:id", p("roles.manage"), validate(roleSchema), asyncHandler(c.update));
export default r;
