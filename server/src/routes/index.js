...
import ongoingWork from "./ongoingWork.routes.js";
import dayEndReports from "./dayEndReport.routes.js";
...
r.use("/notes", notes);
r.use("/ongoing-work", ongoingWork);
r.use("/day-end-reports", dayEndReports);
r.use("/leaves", leaves);
