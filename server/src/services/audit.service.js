...
const categories = {
  ...
  employees: ["EMPLOYEE_CREATED", "EMPLOYEE_UPDATED", "EMPLOYEE_ACTIVATED", "EMPLOYEE_DEACTIVATED", "EMPLOYEE_PASSWORD_RESET", "EMPLOYEE_DELETED", "EMPLOYEE_RESTORED", "PASSWORD_CHANGED"],
